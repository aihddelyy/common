...
function Diy_Part2() {
	...
	export Github_API1="${GITHUB_LINK}/releases/download/${Update_tag}/zzz_api"
	export Github_API2="https://gh-proxy.com/${GITHUB_LINK}/releases/download/${Update_tag}/zzz_api"
